 ...
 */
@Service
public class AggregateMeasurePredicateRepository extends BaseRepository {
    ...
    /**
     * Returns all aggregate measure predicates for the specified cube.
     *
     * @param cubeIri The absolute IRI of the cube.
     * @return Set with all aggregate measure predicate IRIs of the specified cube.
    ...
    public Set<String> getAllByCube(String cubeIri) throws QueryException {
        ...
        logger.debug("Querying all aggregate measure predicates of cube {}.", cubeIri);
        return getAll("/repo_ampred/getAllByCube.sparql", s -> s.replaceAll("###CUBE###", cubeIri));
    }

    /**
     * Returns the labels of the specified aggregate measure predicates.
     *
     * @param lang        The requested language.
     * @param measureIris Collection with aggregate measure predicate IRIs
    ...
    public List<Label> getLabelsByLangAndIris(String lang, Collection<String> measureIris) throws QueryException {
        ...
        logger.debug("Querying labels of aggregate measure predicates {} in language {}.", measureIris, lang);
        return getLabelsByLang(
                "/repo_ampred/getLabelsByLangAndUris.sparql",
                lang,
                s -> s.replace("###IN###", convertToFullIriString(measureIris)));
    }

    /**
     * Returns the labels of all aggregate measure predicates of the specified cube.
     *
     * @param lang    The requested language.
     * @param cubeIri The absolute IRI of the cube.
    ...
    public List<Label> getLabelsByLangAndCube(String lang, String cubeIri) throws QueryException {
        ...
        logger.debug("Querying labels of aggregate measure predicates of cube {} in language {}.", cubeIri, lang);
        return getLabelsByLang(
                "/repo_ampred/getLabelsByLangAndCube.sparql",
                lang,
                s -> s.replace("###CUBE###", cubeIri));
    }

    /**
     * Returns the labels of all aggregate measure predicates of the specified cube except those specified in {@code excluded}.
     *
     * @param lang     The requested language.
     * @param cubeIri  The absolute IRI of the cube.
    ...
    public List<Label> getLabelsByLangAndCubeWithExclusions(String lang, String cubeIri, Collection<String> excluded) throws QueryException {
        ...
        logger.debug("Querying labels of aggregate measure predicates of cube {} in language {} with measures {} excluded.", cubeIri, lang, excluded);
        return getLabelsByLang(
                "/repo_ampred/getLabelsByLangAndCubeWithExclusions.sparql",
                lang,
