...
public class StateMachineFactory {
    ...
    private static SCXML loadSCXML() throws FileNotFoundException, IOException, XMLStreamException, ModelException {
        LOG.debug("Loading resource ida.scxml from classpath");
        URL url = StateMachineFactory.class.getClassLoader().getResource("ida.scxml");
        if (url == null) {
            throw new FileNotFoundException("SCXML-file 'ida.scxml' not found");
        }
