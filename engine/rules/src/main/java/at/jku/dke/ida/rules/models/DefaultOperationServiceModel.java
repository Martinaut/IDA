...
/**
 * Default model used by {@link at.jku.dke.ida.rules.services.OperationService}.
 */
public class DefaultOperationServiceModel extends AbstractServiceModel implements OperationServiceModel {

    private final String userInput;
    private final Map<Integer, Operation> possibleOperations;

    /**
     * Instantiates a new instance of class {@link DefaultOperationServiceModel}.
     *
     ...
     */
    public DefaultOperationServiceModel(String currentState, SessionModel sessionModel, Map<Integer, Operation> possibleOperations) {
     ...
     */
    public DefaultOperationServiceModel(String currentState, Locale locale, EngineAnalysisSituation analysisSituation, Event operation, SessionModel sessionModel,
