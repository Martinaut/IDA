 ...
 */
public class DefaultValueIntentServiceModel extends AbstractServiceModel implements ValueIntentServiceModel {
     ...
     */
    public DefaultValueIntentServiceModel(String currentState, SessionModel sessionModel) {
     ...
     */
    public DefaultValueIntentServiceModel(String currentState, Locale locale, EngineAnalysisSituation analysisSituation, Event operation, SessionModel sessionModel,
