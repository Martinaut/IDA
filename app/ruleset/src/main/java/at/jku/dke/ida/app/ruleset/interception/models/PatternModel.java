...
/**
 * Used by the {@link at.jku.dke.ida.app.ruleset.interception.interceptors.PatternInterceptor}.
 */
public class PatternModel extends DefaultPatternServiceModel {

    private final Collection<Similarity<Displayable>> similarities;

    /**
     * Instantiates a new instance of class {@link PatternModel}.
     *
     ...
     */
    public PatternModel(String currentState, SessionModel sessionModel, Collection<Similarity<Displayable>> similarities) {
     ...
     */
    public PatternModel(String currentState, Locale locale, EngineAnalysisSituation analysisSituation, Event operation,
