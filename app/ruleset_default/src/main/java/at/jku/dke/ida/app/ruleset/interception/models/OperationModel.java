...
/**
 * Used by the {@link at.jku.dke.ida.app.ruleset.interception.interceptors.OperationInterceptor}.
 */
public class OperationModel extends DefaultOperationServiceModel {

    private final Collection<Similarity<Displayable>> similarities;

    /**
     * Instantiates a new instance of class {@link OperationModel}.
     *
     ...
     */
    public OperationModel(String currentState, SessionModel sessionModel, Map<Integer, Operation> possibleOperations,
     ...
     */
    public OperationModel(String currentState, Locale locale, EngineAnalysisSituation analysisSituation, Event operation,
                          SessionModel sessionModel, String userInput, Map<Integer, Operation> possibleOperations,
                          Collection<Similarity<Displayable>> similarities) {
