...
/**
 * Model required by {@link at.jku.dke.inga.rules.services.ValueDeterminationService}.
 */
public class ValueDeterminationServiceModel extends DroolsServiceModel {

    private final String userInput;
    private final Display displayData;

    /**
     * Instantiates a new instance of class {@link ValueDeterminationServiceModel}.
     *
     ...
     */
    public ValueDeterminationServiceModel(String currentState, AnalysisSituation analysisSituation, Locale locale, String userInput, Display displayData) {
