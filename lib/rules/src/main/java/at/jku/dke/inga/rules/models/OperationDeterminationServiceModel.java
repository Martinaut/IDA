...
/**
 * Model required by {@link at.jku.dke.inga.rules.services.OperationDeterminationService}.
 */
public class OperationDeterminationServiceModel extends DroolsServiceModel {

    private final String userInput;
    private final Map<Integer, Operation> possibleOperations;

    /**
     * Instantiates a new instance of class {@link OperationDeterminationServiceModel}.
     *
     ...
     */
    public OperationDeterminationServiceModel(String currentState, AnalysisSituation analysisSituation, Locale locale, String userInput, Map<Integer, Operation> possibleOperations) {
