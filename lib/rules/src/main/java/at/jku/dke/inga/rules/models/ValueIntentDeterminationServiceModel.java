...
/**
 * Model required by {@link at.jku.dke.inga.rules.services.ValueIntentDeterminationService}.
 */
public class ValueIntentDeterminationServiceModel extends DroolsServiceModel {

    private final String userInput;
    private final Display displayData;

    /**
     * Instantiates a new instance of class {@link ValueIntentDeterminationServiceModel}.
     *
     ...
     */
    public ValueIntentDeterminationServiceModel(String currentState, AnalysisSituation analysisSituation, Locale locale, String userInput, Display displayData) {
