...
public class ResolveActionModel extends DataModel<AnalysisSituation> {

    private final String userInput;
    private final Map<Integer, Operation> possibleOperations;

    /**
     * Instantiates a new instance of class {@link ResolveActionModel}.
     *
     ...
     */
    public ResolveActionModel(String currentState, AnalysisSituation analysisSituation, Locale locale,
